            ...
            this, [this]() {
                ...
                if (basicThemeDeclarative()->instance(this)) {
                    ...
                    if (colorSet() == Custom) {
                        ...
                        QMetaObject::invokeMethod(basicThemeDeclarative()->instance(this), "__propagateAccentColor", Q_ARG(QVariant, QVariant::fromValue(this->parent())), Q_ARG(QVariant, focusColor()));
                    }
                }
            });

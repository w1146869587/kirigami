...
Controls.ToolButton {
    ...
    implicitWidth: showText && ( kirigamiAction ? kirigamiAction.text.length > 0 : text.length > 0) ? Math.max(layout.implicitWidth + Units.smallSpacing*2, background.implicitWidth) : implicitHeight

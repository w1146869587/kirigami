...
Item {
    ...
    Item {
        ...
        MouseArea {
            ...
            onPressed: {
                ...
                if (root.hasApplicationWindow && applicationWindow().pageStack.currentIndex !== undefined && root.page.ColumnsView.level !== undefined) {
                    //search the button parent's parent, that is the page parent
                    //this will make the context drawer open for the proper page
                    applicationWindow().pageStack.currentIndex = root.page.ColumnsView.level;
                }
    ...
    MouseArea {
        ...
        visible: root.page.actions && root.page.actions.contextualActions.length > 0 && (applicationWindow === undefined || applicationWindow().wideScreen)
            ...
            && (root.page && root.page.parent ? root.page.ColumnsView.level < applicationWindow().pageStack.depth-1 : false)
